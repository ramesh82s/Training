...
class RolPage
  def fill_all_form_data(locator)
    h = YAML.load(File.read("C:/OAO_Testing/features/support/data/data_source/input_data/rol_login_page_data.yaml"))
  ...
  #   begin
      ...
      # <%= 5+3 %>
       YAML.load(File.read("C:/OAO_Testing/features/support/data/data_source/input_data/rol_login_page_data.yaml")) || Hash.new( {} )
